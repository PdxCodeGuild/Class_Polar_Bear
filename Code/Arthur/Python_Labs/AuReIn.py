...
Let's compute the ARI for a given book.
 The automated readability index (ARI) is a formula for computing
  the U.S. grade level for a given block of text.
...
divided by the number of sentences multiplied by 0.5, and subtracting 21.43.
...
Once you’ve computed the ARI score, you can use the following dictionary
 to look up the age range and grade level.
ari_scale = {
...
--------------------------------------------------------
'''
# # use anybook and use the same policy as previous
...
# with open('C:/Users/REACT/Desktop/pdx_code/New_Polar/Code/Arthur/Python_Labs/rider.txt','r',encoding='utf-8') as file:
#     text = file.read()
...
# ari = (4.71 * (char/text) + 0.5 * (text/sentence) - 21.43)
# ari = math.ceil(ari)
# if ari > 14:
#     ari = 14
# ari_scale = {
