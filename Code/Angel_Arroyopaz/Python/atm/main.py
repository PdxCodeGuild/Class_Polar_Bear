...
while True:
    ...
    if command == 'balance':
        ...
        atm.print_transactions(amount, transaction_type='deposited') # call print_transactions(amount, transaction_type) method
        print(f'Deposited ${amount}')
    elif command == 'withdraw':
        amount = float(input('How much would you like '))
        if atm.check_withdrawal(amount): # call the check_withdrawal(amount) method
            atm.withdraw(amount) # call the withdraw(amount) method
            atm.print_transactions(amount, transaction_type='withdrew') # call print_transactions(amount, transaction_type) method
